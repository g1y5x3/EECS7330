...
%% Calculate the undistorted grouth truth pixels
uv_u = zeros(2,80);
for i = 1 : N
    [uv_u(1,i), uv_u(2,i)] = convert_distor_undistor_ToolBox(uv_d(1,i),uv_d(2,i),kc,KK);
end
...
% measure the error
error_P = uv_estimated_P(1:2,:) - uv_u;
